    ...
    <div className="min-h-screen bg-gray-50">
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4
          mb-6 shadow-sm flex items-center gap-6">
          <div className="text-center">
            <p className="text-2xl font-bold text-blue-600">
              {patients.length}
            </p>
            <p className="text-xs text-gray-500">
              {searchQuery ? "Results" : showArchived ? "Archived" : "Active"}
            </p>
          </div>
        </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  {["Patient No","Name","Gender",
                    "Birth Date","Contact","Status","Actions"].map(h => (
                    <th key={h}
        ...
        {showForm && (
          <Modal
            title={editTarget ? "Edit Patient" : "Register Patient"}
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button type="submit" disabled={submitting}
                  ...
                  {submitting
                    ? "Saving..."
                    : editTarget ? "Update Patient" : "Register Patient"}
                </button>
              </div>
            </form>
          </Modal>
          ...
          <Modal
            ...
            <p className="text-gray-600 mb-4">
              {archiveTarget.archived ? (
                ...
                <>Archive <strong>{archiveTarget.firstName} {archiveTarget.lastName}</strong>?
                  They will be hidden from the active list but their records
                  will be preserved.</>
              )}
            </p>
          ...
          <Modal title="Permanently Delete Patient"
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg
              ...
              <p className="text-red-600 text-sm mt-1">
                All medical records, appointments, consultations,
                prescriptions and bills for this patient will also be deleted.
              </p>
            </div>
